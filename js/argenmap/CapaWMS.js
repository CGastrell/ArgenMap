...
goog.inherits( argenmap.CapaWMS, argenmap.Capa );
...
argenmap.CapaWMS.prototype.toJSON = function()
{
	var s = {
		nombre: this.name,
...
argenmap.CapaWMS.prototype.toString = function()
{
